...
class ResponsiveLoginScreen extends StatefulWidget {
  const ResponsiveLoginScreen({super.key, this.showTopHeader = true});
...
class _ResponsiveLoginScreenState extends State<ResponsiveLoginScreen> {
  ...
  void initState() {
    super.initState();
    _authState = AuthState(pageType: AuthPageType.login);
          ...
          child: Column(
            ...
            children: [
              ...
              if (state.errorMessage != null) ...[
                _messageBanner(state.errorMessage!, AuthColors.red),
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    _title(page.headerTitle, AuthColors.blue, 20,
                        fw: FontWeight.w800),
                    const SizedBox(height: 4),
                    _hint(
                      page.introDescription,
